...
export default async function PendingDuesPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto space-y-4">
      <div className="mb-4">
        <PageHeader
          title="Class-wise Pending Dues List"
          description="Detailed overview of active student outstanding fees, late fines, concessions, and pending months"
        />
      </div>
      <PendingListClient metaData={metaData} />
    </div>
  );
}
