...
import { z } from "zod";
import { dateSchema, optionalDateSchema, idSchema, paginationSchema } from "./common";
...
export const createStudentSchema = z.object({
  ...
  gender: z.preprocess(
    (val) => (typeof val === "string" && val.trim() ? val.toUpperCase().trim() : val || null),
  ...
  category: z.preprocess(
    (val) => (typeof val === "string" && val.trim() ? val.toUpperCase().trim() : val || null),
    z.nativeEnum(StudentCategory).optional().nullable()
  ),
...
export const createStudentWithFamilySchema = z.object({
  ...
  fatherAnnualIncome: z.preprocess(
  ...
  motherAnnualIncome: z.preprocess(
    (val) => (val === "" || val === null || val === undefined ? null : Number(val)),
    z.number().optional().nullable()
  ),
  ...
  sameAsResidential: z.boolean().optional().default(true),
  ...
  declarationDate: optionalDateSchema,
  ...
  enroll: z.boolean().optional().default(true),
